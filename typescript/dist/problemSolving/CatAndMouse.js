...
const catchMouse = (str, j) => {
    ...
    if (catPosition < 0 || dogPosition < 0 || mousePosition < 0)
        return "boring without all three";
    else if (cat_mouse_dis > j)
        return "Escaped!";
    else if ((dogPosition > catPosition && dogPosition < mousePosition) || ((dogPosition < catPosition && dogPosition > mousePosition)))
        return "Protected!";
    else
        return "Caught!";
};
